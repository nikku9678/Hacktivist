    ...
    <div className='container'>
      ...
      gap-[30px]'>
        ...
        <div>
          ...
          leading-7 font-[400] text-textColor mt-4'>Copyright {year} Developed By Kunal Shaw</p>
        ...
        <div>
          <h2 className='text-[20px] leadoing-[30px]
           font-[700] mb-6 text-headingColor'>
            Quick Links
           </h2>
           <ul>
            {quickLinks01.map((item,index)=><li key={index} className='mb-4'>
              <Link to={item.path} className='text-[16px] leading-7 font-[500] text-textColor'>
                {item.display}
              </Link>
            </li>)}
           </ul>
