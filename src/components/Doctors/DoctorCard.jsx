    ...
    <div className='p-3 lg:p-5'>
        ...
        <div className='mt-2 lg:mt-0 flex items-center justify-between'>
            ...
            <div className='flex items-center gap-[6px]'>
                ...
                lg:text-[16] lg:leading-7 font-semibold text-headingColor'>
                <img src={staricon} alt="" />
                {avgRating}
                </span>
                <span className='text-[14px] leading-6
                lg:text-[16] lg:leading-7 font-semibold text-textColor'>({totalRating})</span>
            </div>
        </div>
        <div className='mt-[18px] lg:mt-4 flex items-center justify-between'>
            <div>
